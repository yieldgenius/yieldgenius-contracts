...
import "../IYieldGeniusDistributor.sol";
...
contract MultipleRewards is IMultipleRewards, Ownable, ReentrancyGuard {
    ...
    IYieldGeniusDistributor public immutable distributorV2;
    ...
    modifier onlyDistributorV2() {
        require(
            ...
            "onlyDistributorV2: only YGChef can call this function"
        );
        _;
    }
    ...
    constructor(
        ...
        IYieldGeniusDistributor _distributorV2,
        bool _isNative
    ) {
        require(
        ...
        require(
            ...
            "constructor: YGChef must be a valid contract"
        );
    ...
    /// @notice Function called by YGChef whenever staker claims YG harvest. Allows staker to also receive a 2nd reward token.
