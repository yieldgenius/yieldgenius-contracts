...
contract StrategyBaseChefLP is GasThrottler, StratFeeManager {
     ...
     * @param _commonAddresses vault, unirouter, keeper, strategist, ygFeeRecipient, ygFeeConfig
    ...
    /**
     *@notice Harvests rewards from deposited
     */
    ...
    /**
     *@notice  Harvests rewards from deposited
     *@param callFeeRecipient address of fee receipient
     */
    ...
    /**
     *@notice Harvest function for manager
     */
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        uint256 ygFeeAmount = (nativeBal * fees.beefy) / DIVISOR;
        IERC20(native).safeTransfer(beefyFeeRecipient, ygFeeAmount);

        uint256 strategistFeeAmount = (nativeBal * fees.strategist) / DIVISOR;
        IERC20(native).safeTransfer(strategist, strategistFeeAmount);

        emit ChargedFees(callFeeAmount, ygFeeAmount, strategistFeeAmount);
    }
    ...
    /**
     *@notice Set pendingRewardsFunctionName
     *@param _pendingRewardsFunctionName Function name
     */
     ...
     *@return address Output to lp0 route addresses
     */
