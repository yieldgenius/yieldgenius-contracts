...
contract YieldGeniusUniswapv2Zap {
    ...
    function geniusOut(address beefyVault, uint256 withdrawAmount) external {
    ...
    function _getVaultPair(
        address beefyVault
    ) private view returns (IBeefyVaultV6 vault, IUniswapV2Pair pair) {
